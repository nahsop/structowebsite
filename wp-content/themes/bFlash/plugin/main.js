...
var Slider = function () {
    ...
    var homeSlider = function(){
        ...
        // Pull bullet and navigation values from the data-bullets and data-navigation
        var show_bullets = slider.data('bullets');
        var show_navigation = slider.data('navigation');
        // Set default values for the navigation and bullets
        var dotsClass = 'vk-list vk-dots-nav';
        var dots = true;
        var navigation_class = '';
        // if bullets is not to be shown do the following
        if(show_bullets == 'no'){
            dotsClass = '';
            dots = false;
        }
        // if the navigation is not to be shown do the following
        ...
        //slick run
        slider.slick({
            nextArrow: '<button  class="vk-btn vk-arrow next '+navigation_class+'"><i class="icon ti-angle-right"></i><span class="image-preview-thumbnail"></span></button>',
            prevArrow: '<button  class="vk-btn vk-arrow prev '+navigation_class+'"><i class="icon ti-angle-left"></i><span class="image-preview-thumbnail"></span></button>',
            dotsClass: dotsClass,
            dots: dots,
            fade:true,
            infinite: true,
...
var MasonryItem = function () {
    ...
    var sliderFilter = function () {
        ...
        // if(slider_filter.toString())
        var name = $(slider_filter.toString()).find('.item').eq(0).data('identifier');
        // alert(name);
        if(name != undefined){
